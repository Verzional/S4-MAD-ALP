...
struct UserView: View {
    ...
    @State private var tempProfileImage: Image?
                ...
                ScrollView {
                    VStack(spacing: 32) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text(isRegister ? "Create\nnew account" : "Welcome\nback!")
                                .font(.system(size: geometry.size.width > 600 ? 54 : 42, weight: .bold))
                        ...
                        VStack(spacing: 20) {
                            if isRegister {
                                ...
                                VStack(alignment: .leading, spacing: 4) {
                                    TextField("Full name", text: $userAuth.userModel.name)
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                TextField("Email address", text: $userAuth.userModel.email)
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                SecureField(isRegister ? "Create password" : "Password", text: $userAuth.userModel.password)
                                Divider().background(Color.gray)
                            }
                        }
                        .padding(.horizontal, geometry.size.width > 600 ? 120 : 24)
                        .padding(.top, 12)
                        ...
                        Button {
                            ...
                            Text(isRegister ? "Already have an account? Sign In" : "Don't have an account? Sign Up")
                                .font(.footnote)
                        }
